...
class ConnectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create connection" do
    assert_difference('Connection.count') do
      post connections_url, params: { connection: { date_created: @connection.date_created, mentee_id: @connection.mentee_id, mentor_id: @connection.mentor_id, status: @connection.status } }
    end
  ...
  test "should update connection" do
    patch connection_url(@connection), params: { connection: { date_created: @connection.date_created, mentee_id: @connection.mentee_id, mentor_id: @connection.mentor_id, status: @connection.status } }
