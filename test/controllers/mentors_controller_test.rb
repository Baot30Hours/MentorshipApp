...
class MentorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mentor" do
    assert_difference('Mentor.count') do
      post mentors_url, params: { mentor: { date_created: @mentor.date_created, email: @mentor.email, expertise: @mentor.expertise, job_title: @mentor.job_title, mentee_slots: @mentor.mentee_slots, name: @mentor.name } }
    end
  ...
  test "should update mentor" do
    patch mentor_url(@mentor), params: { mentor: { date_created: @mentor.date_created, email: @mentor.email, expertise: @mentor.expertise, job_title: @mentor.job_title, mentee_slots: @mentor.mentee_slots, name: @mentor.name } }
