class EventsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @event.save
        format.html { redirect_to @event.connection, notice: 'Event was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @event.update(event_params)
        format.html { redirect_to @event.connection, notice: 'Event was successfully updated.' }
